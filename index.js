...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.idwmb.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect(err => {
    const servicesCollection = client.db("DreamCreations").collection("services");
    const orderCollection = client.db("DreamCreations").collection("orders");
